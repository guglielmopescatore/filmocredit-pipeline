...
FUZZY_TEXT_SIMILARITY_SCROLLING_THRESHOLD: Final[int] = 70

# Scene Detection
CONTENT_SCENE_DETECTOR_THRESHOLD: Final[float] = 25.0 #10
THRESH_SCENE_DETECTOR_THRESHOLD: Final[float] = 12  # Increased from 5.0 to be less sensitive to fades
SCENE_MIN_LENGTH_FRAMES: Final[int] = 10
DEFAULT_START_SCENES_COUNT: Final[int] = 100
DEFAULT_END_SCENES_COUNT: Final[int] = 100
INITIAL_FRAME_SAMPLE_POINTS: Final[List[float]] = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]
